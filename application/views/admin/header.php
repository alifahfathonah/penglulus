	...
	<nav class="navbar navbar-inverse navbar-static-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= site_url() ?>">Info Kelulusan <?=$this->fungsi->admin_konfigurasi()->sekolah; ?></a>
			</div>
			<div id="navbar" class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="<?= site_url('admin/data') ?>">Data</a></li>
					<li><a href="<?= site_url('admin/konfigurasi') ?>">Konfigurasi</a></li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="true">
							<span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?= ucfirst($this->fungsi->user_login()->username) ?> <span class="caret"></span>
						</a>
